...
<p align="center">
  <a href="https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=workflow_templates">
    <img src="./assets/atlas-cloud-logo.png" alt="Atlas Cloud" width="200">
  </a>
</p>

> 🎁 **[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=workflow_templates)** — Unified AI API platform powering ComfyUI workflows with state-of-the-art image generation (Flux, DALL-E, Seedream), video generation (Kling, Seedance, Sora), and 59 LLM models via a single OpenAI-compatible endpoint. Drop it into any ComfyUI workflow as the API backend — no infra changes needed. — [Get started](https://www.atlascloud.ai/console/coding-plan)
