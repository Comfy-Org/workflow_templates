...
- [template-site-prd.md](./template-site-prd.md) - Product requirements
...
| Task | Status | Notes |
|------|--------|-------|
| Create content template prompts (tutorial/showcase/comparison/breakthrough) | ✅ Done | `site/knowledge/prompts/` |
...
| File | Purpose |
|------|---------|
| `site/scripts/generate-ai.ts` | Main generation pipeline |
| `site/scripts/sync-tutorials.ts` | Tutorial sync from docs repo |
| `site/knowledge/prompts/system.md` | Base GPT-4o system prompt |
| `site/knowledge/prompts/*.md` | Content template prompts |
| `site/knowledge/tutorials/` | Synced tutorial content |
| `site/overrides/templates/` | Human-edited content |
...
- [template-site-prd.md](./template-site-prd.md)
