export function workflowOgUrl(title: string, thumbnail?: string, creator?: string): string {
...
export function creatorOgUrl(name: string, username: string, avatar?: string): string {
