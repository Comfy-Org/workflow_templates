...
- `site/src/content/` — Content collections (`templates/` is git-ignored and generated by sync; `landing/` is tracked, hand-authored)
...
- `site/docs/use-case-page-guide.md` — Adding/editing SEO use-case landing pages
