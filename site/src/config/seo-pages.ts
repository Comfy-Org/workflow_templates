 ...
 * Editorial copy lives per-slug in `src/content/seo/use-cases/<slug>.json`.
 *
 ...
 * `src/lib/seo/use-case-resolver.ts` for the matching rules.
 */

import type { KeywordModel, WordCountTier } from '../lib/seo/schema';
...
/** Lookup by slug for route `getStaticPaths` and validation. */
export const seoPageBySlug = new Map<string, SeoPageDef>(
