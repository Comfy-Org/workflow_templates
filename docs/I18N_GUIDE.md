...
python3 scripts/sync/sync_data.py --templates-dir ./templates --dry-run
```
...
2. Run `python3 scripts/sync/sync_data.py --templates-dir ./templates`
3. Check `scripts/data/i18n.json` - new template will be added to `_status.pending_templates`
4. Add translations in `scripts/data/i18n.json` under `templates` section
5. Run sync again to apply translations

### Adding Translations

Edit `scripts/data/i18n.json`:
...
2. Run sync script - new tag will be auto-added to `scripts/data/i18n.json`
3. Add tag translations in `scripts/data/i18n.json` under `tags` section
4. Run sync again

## Data Structure

### scripts/data/i18n.json Format
